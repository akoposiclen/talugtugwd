...
<div class="container">
	...
	<div class="row">
	  ...
	  <div class="col-md-10 col-md-offset-1">
			...
			<div>
				<br />
				<p class='indent'>Concessionaires may opt to temporarily close the existing services without having to pay reconnection fees should they decide to open again, provided the duration shall not exceed three (3) months and all remaining obligations are settled.</p>				
			</div>
				...
				<div class="panel panel-default">
				  ...
				  <table class="table">
				    ...
				    <tr>
				    	...
				    	<td>
				    		Pay outstanding accounts, if any 
				    	</td>
				    	<td>				    		
    						<p class='indent'>Accept payment and issue corresponding OR.</p>
   							<p class='indent'>Prepare Disconnection Job Order & forward to:</p>
